...
class AppLocalizations {
  ...
  String get registerRecyclingUnit => translate('register_recycling_unit');
  String get pleaseFillInformationToRegister => translate('please_fill_information_to_register');
  String get unitName => translate('unit_name');
  String get enterUnitName => translate('enter_unit_name');
  String get unitOwnerName => translate('unit_owner_name');
  String get enterUnitOwnerName => translate('enter_unit_owner_name');
  String get enterPassword => translate('enter_password');
  String get passwordMin4Chars => translate('password_min_4_chars');
  ...
  String get unitAddress => translate('unit_address');
  String get enterUnitAddress => translate('enter_unit_address');
  String get locationCaptured => translate('location_captured');
  String get captureUnitLocation => translate('capture_unit_location');
  String get wasteType => translate('waste_type');
  String get unitType => translate('unit_type');
  String get press => translate('press');
  String get shredder => translate('shredder');
  String get washingLine => translate('washing_line');
  String get workersCount => translate('workers_count');
  String get enterWorkersCount => translate('enter_workers_count');
  String get machinesCount => translate('machines_count');
  String get enterMachinesCount => translate('enter_machines_count');
  String get stationCapacity => translate('station_capacity');
  String get enterStationCapacity => translate('enter_station_capacity');
  String get idCardFront => translate('id_card_front');
  String get takeOrSelectFrontId => translate('take_or_select_front_id');
  String get idCardBack => translate('id_card_back');
  String get takeOrSelectBackId => translate('take_or_select_back_id');
  String get rentalContractImage => translate('rental_contract_image');
  String get requiredForPress => translate('required_for_press');
  String get commercialRegisterImage => translate('commercial_register_image');
  String get requiredForWashingShredder => translate('required_for_washing_shredder');
  String get taxCardImage => translate('tax_card_image');
  String get submitRequest => translate('submit_request');
  String get pleaseAddIdCardFront => translate('please_add_id_card_front');
  String get pleaseAddIdCardBack => translate('please_add_id_card_back');
  String get pleaseAddRentalContract => translate('please_add_rental_contract');
  String get pleaseAddCommercialRegister => translate('please_add_commercial_register');
  String get pleaseAddTaxCard => translate('please_add_tax_card');
  String get pleaseSelectWasteType => translate('please_select_waste_type');
  String get pleaseSelectGender => translate('please_select_gender');
  String get pleaseSelectUnitType => translate('please_select_unit_type');
  String get registrationSubmittedSuccessfully => translate('registration_submitted_successfully');
  ...
  String get locationServicesRequired => translate('location_services_required');
  String get openSettings => translate('open_settings');
  String get locationServicesRequiredCapture => translate('location_services_required_capture');
  String get locationPermissionsDenied => translate('location_permissions_denied');
  String get enableLocationPermission => translate('enable_location_permission');
  String get locationPermissionRequired => translate('location_permission_required');
  String get locationCapturedSuccessfully => translate('location_captured_successfully');
  String get failedToGetLocation => translate('failed_to_get_location');
  String get pleaseEnableLocationServices => translate('please_enable_location_services');
